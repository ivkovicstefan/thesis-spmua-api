...
namespace SPMUA.Repository.Migrations
{
    ...
    [Migration("20240201163855_InitializeAdminsTableData")]
    partial class InitializeAdminsTableData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SPMUA.Model.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdminLastName = "Admin",
                            PasswordHash = "$2a$11$O49GrWrVzkBO3jvUa9fGY.hh12Clbk6.HumaYdEwi5abLa8R3Q3ca"
                        });
                });
