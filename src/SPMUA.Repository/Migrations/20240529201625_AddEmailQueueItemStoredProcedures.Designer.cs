...
namespace SPMUA.Repository.Migrations
{
    ...
    [Migration("20240529201625_AddEmailQueueItemStoredProcedures")]
    partial class AddEmailQueueItemStoredProcedures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPMUA.Model.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdminLastName = "Admin",
                            PasswordHash = "$2a$11$WUcxuenu/.CPMMxF2zUN7uHCh0vTg8TvVuz.cEhAAeeWmz0.DH5CG"
                        });
                });
            ...
            modelBuilder.Entity("SPMUA.Model.Models.EmailQueue", b =>
                {
                    ...
                    b.Property<int>("EmailQueueStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmailQueueStatusId");

                    b.ToTable("EmailQueue");
                });

            modelBuilder.Entity("SPMUA.Model.Models.EmailQueueStatus", b =>
                {
                    b.Property<int>("EmailQueueStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmailQueueStatusId"));

                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2");

                    b.Property<string>("EmailQueueStatusName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("EmailQueueStatusId");

                    b.ToTable("EmailQueueStatuses");
            ...
            modelBuilder.Entity("SPMUA.Model.Models.EmailQueue", b =>
                {
                    b.HasOne("SPMUA.Model.Models.EmailQueueStatus", "EmailQueueStatuses")
                        .WithMany("EmailQueue")
                        .HasForeignKey("EmailQueueStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmailQueueStatuses");
                });
